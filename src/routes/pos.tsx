  ...
  return (
    <AppShell>
      <div className="flex h-screen">
        ...
        {/* Cart */}
        <aside className="w-[380px] shrink-0 bg-olive flex flex-col h-screen">
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-card rounded-3xl p-6 max-w-sm w-full max-h-[90vh] overflow-y-auto scroll-pretty">
        ...
        <div className="text-xs text-maroon/80 space-y-1 mb-3">
          <div className="flex justify-between"><span>No.</span><span className="font-mono">{tx.id.slice(0,8)}</span></div>
